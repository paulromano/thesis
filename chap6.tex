...
\cite{net-martin-2012, jcp-siegel-2012-2}. Many of the approximations made in
...
hinder the parallel performance of these calculations \cite{net-martin-2012,
...
code \cite{jcp-brunner-2009} as well as the Mercury \cite{mc-greenman-2009} and
Shift \cite{physor-mervin-2012} Monte Carlo particle transport codes. More
...
the OpenMC Monte Carlo particle transport code \cite{ane-romano-2013}. The
...
The algorithm described in \autoref{sec:tally-server-algorithm} was implemented in OpenMC
